var proto = require('terracoin-protocol')
var struct = proto.struct
var defaultNetMessages = proto.messages.defaultMessages
var DefaultBlock = require('bitcore-lib-terracoin').BlockHeader
...
function createParams (params, assert) {
  ...
  if (!params.Block) {
    ...
    // configure bitcore-lib-terracoin BlockHeader as default block
